...
export const getDefaultKinkContent = (defaultRating: string): InKinkCategory[] => [
    ...
    createKinkCategory("Ass play", ["Giving", "Receiving"], ["Anal toys", "Penetration", "Oral"], defaultRating),
    ...
    createKinkCategory("Domination", ["Self", "Partner"], ["Dominant", "Submissive", "Servitude", "Pet play", "Discipline", "Orgasm control", "Choking"], defaultRating),
    ...
    createKinkCategory("Pain", ["Giving", "Receiving"], ["Pinching", "Clamps", "Spanking", "Flogging", "Hot Wax", "Scratching", "Cutting"], defaultRating),
]